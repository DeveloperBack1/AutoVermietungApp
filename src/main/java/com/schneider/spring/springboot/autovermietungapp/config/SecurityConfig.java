    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/rentals/create").hasAnyAuthority(SecurityPermission.getRentalCreatePermissions())
                        .requestMatchers(HttpMethod.PUT, "/cars/update/{id}").hasAnyAuthority(SecurityPermission.getCarsUpdatePermissions())
                        .requestMatchers(HttpMethod.PUT, "/rentals/{id}").hasAnyAuthority(SecurityPermission.getRentalsUpdatePermissions())
                        .requestMatchers(HttpMethod.DELETE, "/cars/delete/{id}").hasAnyAuthority(SecurityPermission.getCarsDeletePermissions())
                        .requestMatchers(HttpMethod.DELETE, "/rentals/delete/{id}").hasAnyAuthority(SecurityPermission.getRentalsDeletePermissions())
